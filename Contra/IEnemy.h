...
public:
	virtual ~IEnemy() {}
	virtual void Update(float dt, sf::Vector2f playerPos, float scrollOffset) = 0; // Cap nhat di chuyen, tan cong
	...
	virtual void SetDrawPosition(const sf::Vector2f& pos) = 0;
